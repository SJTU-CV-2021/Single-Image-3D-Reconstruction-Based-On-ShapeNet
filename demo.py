...
import json
import math
from configs.data_config import Relation_Config, NYU40CLASSES, NYU37_TO_PIX3D_CLS_MAPPING, SHAPENET_PATH, MATCH_THRESHOLD
...
from utils.matching import pcd_matching
...
def run(cfg):
    ...
    for obj_id, obj_cls in enumerate(current_cls):
        ...
        if best_match[obj_id] != None:
            ...
            copyfile(os.path.join(best_match[obj_id][1], 'model.pcd'), os.path.join(save_path, '%s_%s_s.pcd' % (obj_id, obj_cls)))
